<?php
    if(isset($_POST["instrument"]) && isset($_POST["volume"]) && isset($_POST["key"]))
    {
        $myfile = fopen("midi.txt", "w");
        fwrite($myfile, $_POST["instrument"]);
        fwrite($myfile, "\n");
        fwrite($myfile, $_POST["volume"]);
        fwrite($myfile, "\n");
...
<body>
<img height=50 src="pics/piano.png" onclick="change_instrument(1);">
<img height=50 src="pics/pan_flute.png" onclick="change_instrument(76);">
<img height=50 src="pics/organ.png" onclick="change_instrument(19);">
<img height=50 src="pics/guitar.png" onclick="change_instrument(28);">
<img height=50 src="pics/ds_guitar.png" onclick="change_instrument(31);">
<img height=50 src="pics/bass.png" onclick="change_instrument(38);">
<br>
<!-- Image Map Generated by http://www.image-map.net/ -->
<img src="pics/key.png" usemap="#image-map">
...
<map name="image-map">
    ...
    <area id="key3" title="C" href="#" coords="1,1,2,312,71,312,72,181,53,182,54,3" shape="poly">
    <area id="key4" title="C&sharp;/D&flat;" href="#" coords="55,3,90,178" shape="rect">
    <area id="key5" title="D" href="#" coords="94,3,91,179,74,181,75,310,143,311,144,181,128,178,125,4" shape="poly">
    <area id="key6" title="D&sharp;/E&flat;" href="#" coords="126,2,162,179" shape="rect">
    <area id="key7" title="E" href="#" coords="147,181,145,310,215,310,213,4,164,0,164,180" shape="poly">
    <area id="key8" title="F" href="#" coords="216,4,218,310,285,310,286,182,269,181,267,4" shape="poly">
    <area id="key9" title="F&sharp;/G&flat;" href="#" coords="268,2,305,179" shape="rect">
    <area id="key10" title="G" href="#" coords="289,181,288,309,357,310,357,182,340,179,337,4,307,4,306,178" shape="poly">
    <area id="key11" title="G&sharp;/A&flat;" href="#" coords="339,1,373,180" shape="rect">
    <area id="key0" title="A" href="#" coords="360,183,359,311,428,312,429,180,411,179,411,3,375,3,376,177" shape="poly">
    <area id="key1" title="A&sharp;/B&flat;" href="#" coords="411,3,446,178" shape="rect">
    <area id="key2" title="B" href="#" coords="431,181,431,311,500,312,500,2,449,1,448,178" shape="poly">
</map>
<br>
Update to use ajax
<form method="post">
Instrument:
    <select name="instrument">
        ...
        <option value="19" selected>Rock Organ</option>
        ...
        <option value="104">FX 8 (sci-fi)</option>
    ...
    <br>
    Volume (0-127): <input name="volume" type="range" min="0" max="127" value="127" step="1">
    <br>
    Key: <select name="key">
...
function change_key(input_key)
{
    $('[name=key]').val( input_key );
    $.post( "index.php", { instrument: $('[name=instrument]').val(), volume : $('[name=volume]').val(), key : $('[name=key]').val() } );

}

function change_instrument(instrument)
{
    $('[name=instrument]').val( instrument );
    $.post( "index.php", { instrument: $('[name=instrument]').val(), volume : $('[name=volume]').val(), key : $('[name=key]').val() } );
...
for ($i=0; $i<=11; $i++)
{
    echo "$(\"#key$i\").on(\"click\", function(e){\n";
...
$settings = array("instrument","volume","key");
$my_file = file_get_contents("midi.txt");
$lines = explode("\n",$my_file);

for ($i=0; $i<3; $i++)
{
    $num = intval($lines[$i]);
    echo "\t$('[name=$settings[$i]]').val( $num );\n";
}
